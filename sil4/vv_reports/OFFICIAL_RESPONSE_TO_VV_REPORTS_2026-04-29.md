...
16. Added `RV-443` portable host evidence for supervisor channel query through the session public API critical-section boundary.
17. Added `RV-444` portable host evidence for supervisor frame receive through the session public API critical-section boundary.
