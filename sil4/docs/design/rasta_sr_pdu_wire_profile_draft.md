...
| No redundancy PDU profile | Implemented by `rsrx_codec_get_rasta_redundancy_wire_profile()`, option A no-CRC encode/decode, `TC-CODEC-047`, and `TC-CODEC-049`; CRC-bearing behavior remains follow-up if selected |
