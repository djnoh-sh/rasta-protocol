...
7. `RED-PDU-PARITY-001`: Redundancy PDU profile metadata and option A no-CRC encode/decode behavior are defined; add CRC-bearing behavior only if selected.
