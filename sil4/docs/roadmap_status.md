...
- 최근 업데이트: `TC-CHM-061`/`RV-387`로 channel-manager reset이 runtime state만 초기화하고 cumulative audit counters를 보존하는 contract를 고정했다.
...
| Traceability | In Progress | `traceability_matrix_initial.md`, `RV-030`, `RV-217..RV-326`, `RV-332..RV-387` | 새 policy growth마다 review/spec linkage 유지 |
...
- Latest local verification was green after `RV-387`.
