...
| 인증 증빙 준비 | Medium-High | baseline/vendor execution chain과 smoke regression은 준비됐고 남은 것은 actual runtime/vendor evidence 입력뿐 |
