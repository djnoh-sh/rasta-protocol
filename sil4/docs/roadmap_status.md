...
- 최근 업데이트: `INV-RASTA-001`로 RaSTA 필수 PDU/checksum/timestamp parity와 project-specific MAC/security extension backlog를 분리했다.
- 다음 주력 단계: `RaSTA PDU/checksum/timestamp parity definition`, `actual CI/vendor evidence execution`, `AM263Px/SafeRTOS porting evidence planning`, `redundancy next policy growth`, `protocol sequencing next parity growth`, `transport supervisor runtime feedback growth`
...
| Traceability | In Progress | `traceability_matrix_initial.md`, `RV-030`, `RV-217..RV-326`, `RV-332..RV-398` | 새 policy growth마다 review/spec linkage 유지 |
...
| Codec / Security | In Progress | `TC-CODEC-001..036`, `TC-INT-206`, `TC-INT-208`, `RV-337`, `RV-354..RV-367`, `RV-369..RV-378`, `RV-382..RV-384`, `RV-390`, `INV-RASTA-001` | RaSTA SR PDU/checksum/timestamp parity, redundancy CRC/PDU parity, optional MAC/security extension taxonomy, vendor security vectors |
...
- Latest local verification was green after `RV-397`; `RV-398` was documentation-only and did not require rerun.
...
| R-006 Codec/security | Current codec skeleton, CRC32 optional path, typed status taxonomy, selected CRC integration, calculator injection seam, policy gates, encode/decode stale-output representative evidence, decode null-argument output clear, CRC32 truncated-output clear, CRC32 inner status preservation including transport metadata misuse, reserved-header tamper output clear, unsupported-message/reason output clear, trailing/truncated/oversized payload output clear, direct misuse event/channel output clear, and `INV-RASTA-001` inventory are in place. | RaSTA SR PDU/checksum/timestamp parity, RaSTA redundancy CRC/PDU parity, optional MAC/security extension definition, additional tamper taxonomy, vendor-oriented security negative vectors | RaSTA parity profile definition |
...
| RaSTA PDU/checksum/timestamp parity | Not Started | exact official/customer RaSTA clause mapping, SR PDU field profile, timestamp/window policy, checksum/hash profile selection |
...
4. `RaSTA PDU/Checksum/Timestamp Parity Definition`
