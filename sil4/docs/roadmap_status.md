...
- 최근 업데이트: `RV-533`으로 RaSTA SR wire-profile draft의 current baseline 표현을 default 16-byte skeleton과 selected no-checksum 28-byte SR host profile로 분리해 정렬했다.
...
| Traceability | In Progress | `traceability_matrix_initial.md`, `RV-030`, `RV-217..RV-326`, `RV-332..RV-533` | 새 policy/evidence growth마다 review/spec linkage 유지 |
