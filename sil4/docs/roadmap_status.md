...
| 인증 증빙 준비 | High- | baseline/vendor execution chain, input collection, smoke regression은 준비됐고 남은 것은 actual runtime/vendor evidence 입력뿐 |
