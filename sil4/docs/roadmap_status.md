...
- 최근 업데이트: `TC-CODEC-050`/`RV-500`으로 RaSTA redundancy carried SR bridge outer oversized carried-packet status-preservation vector를 추가했다.
...
| Traceability | In Progress | `traceability_matrix_initial.md`, `RV-030`, `RV-217..RV-326`, `RV-332..RV-500` | 새 policy/evidence growth마다 review/spec linkage 유지 |
...
- Latest local verification was green after `RV-500`.
