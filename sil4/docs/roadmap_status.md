...
- 최근 업데이트: `RV-531`로 RaSTA SR wire-profile draft의 stale disconnect-reason delta 문구를 정리했고, `TC-CODEC-039` 기준 current mapping boundary가 구현/검증된 상태임을 명확히 했다.
...
| Traceability | In Progress | `traceability_matrix_initial.md`, `RV-030`, `RV-217..RV-326`, `RV-332..RV-531` | 새 policy/evidence growth마다 review/spec linkage 유지 |
