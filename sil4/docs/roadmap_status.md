...
| IP-003 | Protocol context maturation | confirmation validation, invalid/regressing confirmation integration, sequence gap detail, recovery success semantics, retransmission confirm rules, duplicate inbound rejection 구현 | richer edge cases 보강 |
