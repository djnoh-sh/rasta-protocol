...
- 최근 업데이트: `TC-API-020`/`RV-447`로 transport query/receive public API가 portable critical-section balanced matrix에 포함되도록 보강했다.
...
| Traceability | In Progress | `traceability_matrix_initial.md`, `RV-030`, `RV-217..RV-326`, `RV-332..RV-447` | 새 policy/evidence growth마다 review/spec linkage 유지 |
...
- Latest local verification was green after `RV-447`.
