...
- 최근 업데이트: `TC-CODEC-045`/`RV-487`로 identity+timestamp handoff에서 null packet reject도 stale decoded-message 없이 clear됨을 보강했다.
...
| Traceability | In Progress | `traceability_matrix_initial.md`, `RV-030`, `RV-217..RV-326`, `RV-332..RV-487` | 새 policy/evidence growth마다 review/spec linkage 유지 |
...
- Latest local verification was green after `RV-487`.
