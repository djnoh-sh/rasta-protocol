...
- 최근 업데이트: `TC-INT-209`/`RV-397`로 session-supervisor integration에서도 reset 이후 same context startup/connect/handshake 재진입 contract를 고정했다.
...
| Traceability | In Progress | `traceability_matrix_initial.md`, `RV-030`, `RV-217..RV-326`, `RV-332..RV-397` | 새 policy growth마다 review/spec linkage 유지 |
...
- Latest local verification was green after `RV-397`.
