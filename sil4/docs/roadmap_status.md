...
- 최근 업데이트: `TC-CODEC-058`/`RV-517`로 RaSTA SR no-checksum payload-bearing `DATA` hand-authored wire fixture decode evidence를 추가했다.
...
| Traceability | In Progress | `traceability_matrix_initial.md`, `RV-030`, `RV-217..RV-326`, `RV-332..RV-517` | 새 policy/evidence growth마다 review/spec linkage 유지 |
