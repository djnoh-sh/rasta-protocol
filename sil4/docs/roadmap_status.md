...
- 최근 업데이트: `TC-CODEC-035`/`RV-384`로 CRC32 calculator injection seam의 public header contract를 고정했다.
...
| Traceability | In Progress | `traceability_matrix_initial.md`, `RV-030`, `RV-217..RV-326`, `RV-332..RV-384` | 새 policy growth마다 review/spec linkage 유지 |
...
- Latest local verification was green after `RV-384`.
