...
- 최근 업데이트: `RV-532`로 RaSTA normative feature inventory의 SR PDU/numeric mapping/disconnect reason 상태를 current selected no-checksum host baseline과 정렬했다.
...
| Traceability | In Progress | `traceability_matrix_initial.md`, `RV-030`, `RV-217..RV-326`, `RV-332..RV-532` | 새 policy/evidence growth마다 review/spec linkage 유지 |
