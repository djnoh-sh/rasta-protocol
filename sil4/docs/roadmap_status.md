...
| R-003 | redundancy policy 미완 | holdoff와 flap soak/refresh reset, flap transient soak, flap transient long-run soak, flap transient long-run stale completion soak, channel-up holdoff transient soak 검증은 있으나 richer hysteresis와 장시간 stability 규칙이 없다 | redundancy policy 세분화와 longer-run integration 확장 |
