...
- 최근 업데이트: `TC-INT-210`/`RV-502`로 RaSTA redundancy SR integration oversized carried-packet codec-status propagation evidence를 추가했다.
...
| Traceability | In Progress | `traceability_matrix_initial.md`, `RV-030`, `RV-217..RV-326`, `RV-332..RV-502` | 새 policy/evidence growth마다 review/spec linkage 유지 |
