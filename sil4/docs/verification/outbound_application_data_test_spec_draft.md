...
| TC-OUT-007 | FR-003 | outbound telemetry 누적 검증 | session/adapter 초기화 완료 | success, repeated busy reject, inbound clear, feedback clear 경로 수행 | accepted/busy/clear telemetry와 consecutive/max busy reject streak가 기대값으로 누적된다 | direct-send backpressure policy가 관찰 가능한 counter로 남는다 |
