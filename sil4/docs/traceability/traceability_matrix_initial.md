...
| SR-004 | HZ-006 | HLD-001, LLD-007 | `sil4/include/rsrx_api.h`, `sil4/src/rsrx_api.c` | `rsrx_session_disconnect`, `rsrx_session_process_event`, `rsrx_session_send_application_data`, `rsrx_session_reset` | TC-API-002, TC-API-003, TC-API-006, TC-API-020, TC-API-021 | RV-434 | Draft |
...
| IF-001 |  | HLD-001, LLD-007 | `sil4/include/rsrx_api.h` | `rsrx_session_init`, `rsrx_session_start`, `rsrx_session_connect`, `rsrx_session_disconnect`, `rsrx_session_process_event`, `rsrx_session_process_timer_expiry`, `rsrx_session_get_state`, `rsrx_session_send_application_data`, `rsrx_session_reset` | TC-API-001, TC-API-003, TC-API-004, TC-API-005, TC-API-006, TC-API-007, TC-API-008, TC-API-009, TC-API-012, TC-API-013, TC-API-016, TC-API-017, TC-API-018, TC-API-019, TC-API-020, TC-API-021 | RV-296, RV-297, RV-298, RV-302, RV-392, RV-395, RV-396, RV-427, RV-432, RV-434 | Draft |
...
| IF-002 | HZ-007 | HLD-001, LLD-007 | `sil4/src/rsrx_api.c` | `eEnterSessionCriticalSection`, `eExitSessionCriticalSection`, public API entry points | TC-API-020, TC-API-021 | RV-434 | Draft |
