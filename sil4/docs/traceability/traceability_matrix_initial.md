...
| FR-003 | HZ-003 | HLD-001 | `sil4/tests/integration/test_rsrx_session_supervisor_flow.c` | `vTestIntegratedHoldoffActiveLossBypassLongRunFlow` | TC-INT-105 |  | Draft |
...
| FR-003 | HZ-003 | HLD-001 | `sil4/tests/unit/test_rsrx_platform_adapters.c` | `vTestOutboundQueueBackpressureCloseoutMatrix` | TC-OUT-014 | RV-241 | Draft |
...
| FR-003 | HZ-003 | HLD-001 | `sil4/tests/integration/test_rsrx_session_supervisor_flow.c` | `vTestIntegratedQueueBackpressureCloseoutFlow` | TC-INT-100 | RV-241 | Draft |
...
| SR-002 | HZ-002 | HLD-001 | `sil4/tests/integration/test_rsrx_session_supervisor_flow.c` | `vTestIntegratedHoldoffActiveLossBypassLongRunFlow` | TC-INT-105 |  | Draft |
...
| IF-001 |  | HLD-001 | `sil4/tests/unit/test_rsrx_platform_adapters.c` | `vTestOutboundQueueBackpressureCloseoutMatrix` | TC-OUT-014 | RV-241 | Draft |
...
| IF-001 |  | HLD-001 | `sil4/tests/integration/test_rsrx_session_supervisor_flow.c` | `vTestIntegratedQueueBackpressureCloseoutFlow` | TC-INT-100 | RV-241 | Draft |
