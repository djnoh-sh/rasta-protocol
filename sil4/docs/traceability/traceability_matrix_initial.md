...
| FR-003 | HZ-003 | HLD-001 | `sil4/tests/integration/test_rsrx_session_supervisor_flow.c` | `vTestIntegratedRetransmissionFailoverRecoveryFlow`, `vTestIntegratedRetransmissionFailoverTimeoutFlow`, `vTestIntegratedRetransmissionFailoverRepeatedGapRecoveryFlow` | TC-INT-033, TC-INT-034, TC-INT-036 | RV-030 | Draft |
...
| FR-004 | HZ-003 | HLD-001 | `sil4/tests/integration/test_rsrx_session_supervisor_flow.c` | `vTestIntegratedRetransmissionFailoverRecoveryFlow`, `vTestIntegratedRetransmissionFailoverTimeoutFlow`, `vTestIntegratedRetransmissionFailoverRepeatedGapRecoveryFlow`, `vTestIntegratedRetransmissionFailoverStaleProtocolErrorFlow` | TC-INT-033, TC-INT-034, TC-INT-036, TC-INT-037 | RV-030 | Draft |
...
| SR-002 | HZ-002 | HLD-001 | `sil4/tests/integration/test_rsrx_session_supervisor_flow.c` | `vTestIntegratedRetransmissionTimeoutFailSafeFlow`, `vTestIntegratedRetransmissionFailoverRecoveryFlow`, `vTestIntegratedRetransmissionFailoverTimeoutFlow`, `vTestIntegratedRetransmissionFailoverRepeatedGapRecoveryFlow` | TC-INT-032, TC-INT-033, TC-INT-034, TC-INT-036 | RV-030 | Draft |
