...
| FR-003 | HZ-003 | HLD-001, LLD-014 | `sil4/tests/unit/test_rsrx_channel_manager.c` | `vTestPreferredRecoveryFlapPenaltyHoldoff` | TC-CHM-053 | RV-283 | Draft |
...
| FR-003 | HZ-003 | HLD-001 | `sil4/tests/integration/test_rsrx_session_supervisor_flow.c` | `vTestIntegratedChannelUpFlapPenaltyFlow` | TC-INT-201 | RV-283 | Draft |
...
| FR-003 | HZ-003 | HLD-001 | `sil4/tests/unit/test_rsrx_transport_supervisor.c` | `vTestSupervisorSwitchAuditFlapPenaltyMatrix` | TC-SUP-065 | RV-283 | Draft |
